        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown  align="right" width="48">
                    <x-slot name="trigger">
                        <button class="bg-blue-900  inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div class="font-bold text-lime-500">{{ Auth::user()->name }}</div>
                    ...
                    <x-slot name="content" >
                        <x-dropdown-link class="text-lime-500" :href="route('profile.edit')">
                            {{ __('Profile') }}
                        </x-dropdown-link>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link class="text-lime-500" :href="route('logout')"
