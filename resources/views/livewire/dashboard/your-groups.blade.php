            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="add-group">
                    ...
                    <div>
                        ...
                        <button wire:click="saveGroup" type="button" class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-500 focus:outline-none dark:focus:ring-blue-500">Groep aanmaken</button>
                    </div>
                </div>
            </div>
        </div>
